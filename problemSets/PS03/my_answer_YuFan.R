...
summary(model)
#vote share=0.579+0.0417*difflog
...
#Residuals from Question 1=-3.353e-18+0.6401*Residuals from Question2
...
#(3)
#residuals_question1=-3.353e-18+0.6401*residuals_question2
